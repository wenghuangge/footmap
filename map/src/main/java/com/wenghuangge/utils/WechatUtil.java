...
import com.wenghuangge.bean.po.WechatError;
import com.wenghuangge.bean.po.WechatUser;
import com.wenghuangge.config.WechatConfig;
import com.wenghuangge.constant.WechatApiConstant;
import lombok.Data;
...
public class WechatUtil {
    ...
    public static  WechatUser decryptUser1(String sessionKey, String encryptedData, String ivStr){
        try {
            String result = AesCbcUtil.decrypt(encryptedData, sessionKey, ivStr, "UTF-8");
